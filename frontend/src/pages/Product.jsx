      ...
      <div className="border-t-2 pt-10 py-40">
        ...
        <div className="flex gap-10 flex-row">
          ...
          <div className="flex-1">
            ...
            <Button icon={<ShoppingCartOutlinedIcon fontSize="small" />} className="px-4 py-4 text-sm my-2" onClick={() => setSize(item)} size="large" color="default" variant="solid">Add To Cart</Button>
